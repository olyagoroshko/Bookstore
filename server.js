...
app.get("/shop-grid", authenticationMiddleware(),
    function(req, res) {
...
app.get("/shop-grid-biography", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-business", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-cooking", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-health", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-history", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-mystery", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-inspiration", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-romance", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-fiction", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-self-improvement", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-humor", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.get("/shop-grid-fairy-tale", authenticationMiddleware(),
    function(req, res) {
        let from = req.query.from;
        let to = req.query.to;
        if (from == null) from = 0;
...
app.post('/wishlist', authenticationMiddleware(), function(req, res) {
    ...
    console.log(req.body.key);
    if (req.body.key.length != 0) {
        pool.query('SELECT idBook,Title,IsInStore,Price,idAuth FROM books WHERE idBook IN(' + req.body.key.join(',') + ')', function(err, result, fields) {
            if (err) throw err;
            console.log(result);
            for (let i = 0; i < result.length; i++) {
                books[result[i]["idBook"]] = result[i];
